...
';
							...
							echo '</tbody><tr id="spacertr"><td class="emptycol" colspan="13"><a class="showgrants" id="shownotfundedgrants">Click to show Not Funded grants</a></td></tr><tbody class="avoid-sort grantsbody" id="notfundedgrantsbody">';
