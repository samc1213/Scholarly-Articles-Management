	        ...
	        <header class="clearfix">
	        	<?php
					...
					if (isset($_SESSION['username'])) {
						echo '<button id="logoutheaderbutton" class="logbutton">Logout</button><div id="userspacer"><a href="user.php" id="userlink"><i class="fa fa-user" id="manageuserbtn"></i></a></div>';
					}
					else {
